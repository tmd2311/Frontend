...
const ShopDetails: React.FC<ShopDetailsProps> = ({ productId }) => {
  console.log('ShopDetails received productId:', productId);
  ...
  useEffect(() => {
    if (productId) {
      getProductById(productId).catch(console.error);
    }
  ...
  if (errorDetail) {
    return (
      <>
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            <p className="text-red-600 mb-4">Error: {errorDetail}</p>
            <button 
              onClick={() => router.back()}
  ...
  if (!productDetail) {
    return (
      <>
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            <p className="text-gray-600 mb-4">No product selected. Please select a product to view details.</p>
            <button 
              onClick={() => router.back()}
              className="bg-blue text-white px-6 py-2 rounded-md hover:bg-blue-dark transition-colors"
            >
            ...
            <div className="lg:max-w-[570px] w-full">
              <div className="lg:min-h-[512px] rounded-lg shadow-1 bg-gray-2 p-4 sm:p-7.5 relative flex items-center justify-center">
                <div>
                  ...
                  <Image
                    src={productDetail.images?.[previewImg] ?? "/images/placeholder.png"}
            ...
            <div className="max-w-[539px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-5.5 mb-4.5">
                <div className="flex items-center gap-2.5">
                  ...
                  <span>({productDetail.reviews || 5} customer reviews)</span>
                </div>
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <path
                                    d="M10.28 0.280029L3.5 7.06003L1.22 4.78003C0.829995 4.39003 0.169995 4.39003 -0.220005 4.78003C-0.610005 5.17003 -0.610005 5.83003 -0.220005 6.22003L2.5 8.94003C2.89 9.33003 3.55 9.33003 3.94 8.94003L11.22 1.66003C11.61 1.27003 11.61 0.610029 11.22 0.220029C10.83 -0.169971 10.17 -0.169971 9.78 0.220029L10.28 0.280029Z"
                                    fill="white"
                                  />
                                </svg>
                              </span>
          ...
          <div>
            ...
            >
              <div className="space-y-4">
                <div className="flex py-4 px-4 sm:px-5 even:bg-gray-1 rounded-md">
                  <div className="max-w-[450px] min-w-[140px] w-full">
                    <p className="text-sm sm:text-base text-dark font-medium">Product ID</p>
                  </div>
                  <div className="w-full">
                    <p className="text-sm sm:text-base text-dark">{productDetail.id}</p>
                  </div>
                </div>
                <div className="flex py-4 px-4 sm:px-5 even:bg-gray-1 rounded-md">
                  <div className="max-w-[450px] min-w-[140px] w-full">
                    <p className="text-sm sm:text-base text-dark font-medium">Price</p>
                  </div>
                  <div className="w-full">
                    <p className="text-sm sm:text-base text-dark">${productDetail.price}</p>
                  </div>
                </div>
                <div className="flex py-4 px-4 sm:px-5 even:bg-gray-1 rounded-md">
                  <div className="max-w-[450px] min-w-[140px] w-full">
                    <p className="text-sm sm:text-base text-dark font-medium">Stock Status</p>
                  </div>
                  <div className="w-full">
                ...
                <div className="flex py-4 px-4 sm:px-5 even:bg-gray-1 rounded-md">
                  <div className="max-w-[450px] min-w-[140px] w-full">
                    <p className="text-sm sm:text-base text-dark font-medium">Rating</p>
                  </div>
                  <div className="w-full">
                    <p className="text-sm sm:text-base text-dark">{productDetail.rating}/5 stars</p>
                  </div>
                </div>
              </div>
            </div>
